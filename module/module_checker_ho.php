...
<div class="portlet light bordered">
                                            <div class="portlet-title">
                                                <div class="caption">
                                                    ...
                                                    <span class="caption-subject font-red-haze bold uppercase">Checker of Head Office </span>
    ...
    echo "<hr><div class='alert alert-danger alert-dismissable'><button type='button' class='close' data-dismiss='alert' aria-hidden='true'></button>Reject Transaksi Gagal...!  </div>";
     ...
     ?>
                            ...
                            <div class="portlet box grey-gallery">
                                ...
                                $query.= " left join user_account e on e.nik=a.id_user WHERE a.status='1'  order by a.idtrans_out asc ";
                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    ...
                                    <div class="portlet-body">
                                                ...
                                                <!-- BEGIN FORM-->
                                        <form action="<?php echo "module/action/actions_master?module=$module&pm=$pm&act=check_ho"; ?>" class="form-horizontal"  id="form_sample_1" method="POST" enctype="multipart/form-data">
