                                                        ...
                                                        <div class="row">
                                                            ...
                                                            ?>
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-9">
                                                                        <p class="form-control-static"> <i class="fa fa-file"></i> <i><?php echo $row2['nama_ls_underlying']; ?></i> </p>
                                                                    </div>
                                                                </div>
...
?>
                                                ...
                                                <div class="col-md-12">
                                                 <div class="form-group">
                                                <label class="control-label col-md-3 bold">Description 
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <button type="submit" class="btn green" value="approve" name="var_a">Approve </button>
                                                    <button type="submit" class="btn red" value="reject" name="var_a">Reject </button>
