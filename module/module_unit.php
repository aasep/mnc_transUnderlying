                                    ...
                                    <div class="portlet light bordered">
                                            <div class="portlet-title">
                                                <div class="caption">
                                                    ...
                                                    <span class="caption-subject font-green-haze bold uppercase">Add Unit </span>
                                                    <span class="caption-helper">Additional unit ...</span>
                                                </div>
                                                
                                            </div>
                                    <div class="portlet-body form">
                                                <!-- BEGIN FORM-->
                                                <form action="<?php echo "module/action/actions_master?module=$module&pm=$pm&act=add_unit"?>" id="form_sample_1" class="form-horizontal" method="POST" enctype="multipart/form-data">
                                        <div class="form-body">
                                            ...
                                            <div class="alert alert-success display-hide">
                                                ...
                                                <div class="form-group">
                                                    <label class="control-label col-md-3">Nama Unit
                                                        <span class="required"> * </span>
                                                    </label>
                                                    <div class="col-md-6">
                                                    <input type="text" name="nama_unit" id="nama_unit" data-required="1" class="form-control"  /> </div>
                                                </div>
                                        </div>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="portlet light bordered">
                                            <div class="portlet-title">
                                                <div class="caption">
                                                    <i class="icon-equalizer font-green-haze"></i>
                                                    <span class="caption-subject font-green-haze bold uppercase">Edit Unit </span>
                                                    <span class="caption-helper">Update Unit ...</span>
                                                </div>
                                                
                                            </div>
                                    <div class="portlet-body form">
                                                <!-- BEGIN FORM-->
                                                <form action="<?php echo "module/action/actions_master?module=$module&pm=$pm&act=edit_unit"?>" id="form_sample_3" class="form-horizontal" method="POST" enctype="multipart/form-data">
                                        <div class="form-body">
                                            <div class="alert alert-danger display-hide">
                                                <button class="close" data-close="alert"></button> You have some form errors. Please check below. </div>
                                            <div class="alert alert-success display-hide">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6">
                                                    <input type="text" name="ed_nama_unit" id="ed_nama_unit" data-required="1" class="form-control"  />
                                                    <input type="hidden" name="ed_id_unit" id="ed_id_unit" data-required="1" class="form-control"  />
                                    ...
                                    <div class="portlet light bordered">
                                            <div class="portlet-title">
                                                <div class="caption">
                                                    ...
                                                    <span class="caption-subject font-red-haze bold uppercase">Confirm Delete Unit </span>
                                                    <span class="caption-helper">Dispose unit ...</span>
                                                </div>
                                                
                                            </div>
                                    <div class="portlet-body form">
                                                <!-- BEGIN FORM-->
                                                <form action="<?php echo "module/action/actions_master?module=$module&pm=$pm&act=delete_unit"?>"  class="form-horizontal" method="POST" >
                                        <div class="form-body">
...
?>
						...
						<div class="portlet light bordered">
									<div class="portlet-title">
										<div class="caption">
											...
											<span class="caption-subject font-red-sunglo bold uppercase"> Unit</span>
						...
						<a href="#large" data-toggle="modal" class="btn green"> Add Unit <i class="fa fa-plus"></i> </a>
						 <hr>   
							...
							echo "<td style='font-size:12px'>$row[nama_unit]</td>";
							echo "<td style='font-size:12px'><a href='#'  data-toggle='modal' data-target='#view-edit' id-nama='$row[nama_unit]' id-unit='$row[id_unit]' class='detailEdit' ><button class='btn default'>Edit</button></a><a href='#'  data-toggle='modal' id-unit='$row[id_unit]' id-nama='$row[nama_unit]' data-target='#delete-modal' class='detailDelete' > <button class='btn red'>Delete</button></a></td>";
							echo "</tr>";
							$i++;
